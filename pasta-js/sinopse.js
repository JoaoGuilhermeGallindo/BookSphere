const livros = {
  ...
  "schopenhauer": {
    titulo: "Schopenhauer",
    autor: "Thomas Mann",
    paginas: "27 Páginas - PDF",
    paginas2: "27 Páginas - ONLINE",
    capa: "../Capas/Schopenhauer.jpg",
    sinopse: "O livro Schopenhauer, de Thomas Mann, é um breve ensaio em que o autor apresenta o pensamento do filósofo Arthur Schopenhauer, destacando seu pessimismo, a ideia da vontade como força que move o mundo e a arte como forma de libertação do sofrimento. Mann reflete sobre como essas ideias influenciaram a literatura e expressam uma visão profunda e melancólica da existência humana.",
    pdf: "Schopenhauer.pdf",
  },
  "o-abolicionismo": {
    titulo: "O Abolicionismo",
    autor: "Joaquim Nabuco",
    paginas: "104 Páginas - PDF",
    paginas2: "214 Páginas - ONLINE",
    capa: "../Capas/OAbolicionismo.jpg",
    sinopse: "Escrito por Joaquim Nabuco, um dos maiores líderes do movimento abolicionista brasileiro, O Abolicionismo é um manifesto político e social que denuncia os males da escravidão e defende a urgência da liberdade como condição para o progresso nacional. Publicado em 1883, o livro reúne reflexões e discursos que marcaram a luta pela abolição, mostrando como o sistema escravocrata atrasava o desenvolvimento do Brasil e perpetuava injustiças. Mais do que um apelo humanitário, a obra é um chamado à reconstrução da sociedade brasileira sobre os pilares do trabalho livre e da igualdade.",
    pdf: "OAbolicionismo.pdf",
  },

  "A-Comedia-dos-Erros": {
    titulo: "A Comédia dos Erros",
    autor: "William Shakespeare",
    paginas: "106 Páginas - PDF",
    paginas2: "106 Páginas - ONLINE",
    capa: "../Capas/A-Comédia-dos-Erros.jpg",
    sinopse: "Esta peça é uma das comédias mais curtas e agitadas de Shakespeare, centrada em confusões de identidade. Dois pares de gêmeos — Antífolo de Siracusa e Antífolo de Éfeso, junto com seus criados Dromio de Siracusa e Dromio de Éfeso — foram separados na infância. Quando os irmãos de Siracusa chegam a Éfeso, uma série de mal-entendidos hilários se desenrola: dívidas não reconhecidas, esposas confusas, prisões injustas e até suspeitas de loucura. Tudo culmina em um reencontro emocionante e esclarecedor que resolve os equívocos e restaura a ordem.",
    pdf: "AComediadosErros.pdf",
  },
  "Romeu-e-Julieta": {
  ...
  "capitulos-de-historia-colonial-(1500-1800)": {
    ...
    autor: "Joaquim Nabuco",
    paginas: "121 Páginas - PDF",
    paginas2: "235 Páginas - ONLINE",
    capa: "../Capas/CapitulosdeHistoriaColonial(1500-1800).jpg",
    sinopse: "Capítulos de História Colonial (1500-1800), de João Capistrano de Abreu, é um clássico da historiografia brasileira publicado em 1907. A obra analisa os três primeiros séculos da colonização portuguesa no Brasil, destacando a diversidade social, econômica e cultural que moldou o país.",
    pdf: "CapítulosdeHistóriaColonial(1500-1800).pdf",
  },
  "historia-da-literatura-brasileira": {
    titulo: "História da Literatura Brasileira",
    autor: "Sílvio Romero",
    paginas: "131 Páginas - PDF",
    paginas2: "308 Páginas - ONLINE",
    capa: "../Capas/HistoriadaLiteraturaBrasileira.webp",
    sinopse: "História da Literatura Brasileira: Fatores da Literatura Brasileira, de Sílvio Romero, é uma obra publicada no final do século XIX que busca explicar a formação da literatura nacional a partir de elementos históricos, sociais, raciais e culturais. O livro é considerado um marco da crítica literária brasileira, pois inaugura uma visão científica e comparativa sobre a produção literária do país.",
  ...
  "edipo-rei": {
    titulo: "Édipo Rei",
    autor: "Sófocles",
    paginas: " 74 Páginas - PDF",
    paginas2: "74 Páginas - ONLINE",
    capa: "../Capas/EdipoRei.jpg",
    sinopse: "Édipo Rei, tragédia escrita por Sófocles por volta de 427 a.C., narra a história do rei de Tebas que, sem saber, cumpre a profecia de matar o próprio pai e casar-se com a mãe. Considerada por Aristóteles a maior tragédia grega, a peça explora destino, culpa e a busca pela verdade.",
    pdf: "Edipo-Rei.pdf",
  },
  "minha-formacao": {
  ...
  "a-desobediencia-civil": {
    ...
    paginas: " 49 Páginas - PDF",
    paginas2: "49 Páginas - ONLINE",
    capa: "../Capas/Adesobedienciacivil.jpg",
    sinopse: "O livro A desobediência civil, de Henry David Thoreau, é um ensaio em que o autor defende o direito e o dever do indivíduo de desobedecer leis injustas. Escrito em 1849, o texto nasceu da recusa de Thoreau em pagar impostos que financiavam a escravidão e a guerra. Ele argumenta que a consciência moral deve estar acima da autoridade do Estado e que a verdadeira justiça depende da ação ética de cada pessoa. A obra tornou-se um marco do pensamento político e libertário, influenciando líderes como Gandhi e Martin Luther King Jr.",
    pdf: "desobedienciacivil.pdf",
  },
  "a-campanha-abolicionista": {
    titulo: "A Campanha Abolicionista",
    autor: "José Carlos do Patrocínio",
    paginas: " 165 Páginas - PDF",
    paginas2: "192 Páginas - ONLINE",
    capa: "../Capas/ACampanhaAbolicionista.jpg",
    sinopse: "A Campanha Abolicionista, de José Carlos do Patrocínio, reúne discursos, artigos e reflexões do autor sobre a luta pela abolição da escravidão no Brasil. Publicada originalmente em periódicos e depois organizada em livro, a obra mostra o papel central de Patrocínio como jornalista, orador e ativista na mobilização popular que culminou na Lei Áurea de 1888.",
    pdf: "ACampanhaAbolicionista.pdf",
  },
  ...
  "TristeFimdePolicarpoQuaresma": {
    ...
    paginas: "104 Páginas - PDF",
    paginas2: "211 Páginas - ONLINE",
    sinopse: "Romance publicado em 1915, acompanha Policarpo Quaresma, um funcionário público apaixonado pelo Brasil e suas tradições. Idealista, ele acredita que o país pode alcançar grandeza se valorizar sua cultura e recursos. Porém, suas ideias nacionalistas — como propor o tupi como língua oficial e investir na agricultura — acabam sendo vistas como excêntricas ou inviáveis. A trajetória do personagem revela o choque entre idealismo e realidade, culminando em um desfecho trágico que critica a política e a sociedade brasileira da época.",
    pdf: "Triste-Fim-de-Policarpo-Quaresma.pdf",
  },
  "DiarioIntimo": {
    titulo: "Diário Íntimo",
    autor: "Afonso Henriques de Lima Barreto",
    capa: "../Capas/Diario-Intimo.jpg",
    paginas: "135 Páginas - PDF",
    paginas2: "178 Páginas - ONLINE",
    sinopse: "Obra póstuma, reúne reflexões pessoais de Lima Barreto, escritas entre 1903 e 1921. O autor expõe suas angústias, críticas sociais, dificuldades financeiras e experiências com o alcoolismo e internações psiquiátricas. É um testemunho sincero e doloroso de sua vida, revelando tanto sua sensibilidade literária quanto sua luta contra preconceitos e exclusão social.",
    pdf: "Diario-Intimo.pdf",
  },
  "quincasborba": {
  ...
  "bom-crioulo": {
    ...
    paginas: "68 Páginas - PDF",
    paginas2: "177 Páginas - ONLINE",
    sinopse: 'Publicado em 1895, "Bom Crioulo" é considerado o primeiro romance brasileiro a tratar abertamente da homossexualidade. A obra acompanha Amaro, um marinheiro negro que, após uma vida marcada pela escravidão e disciplina militar, envolve-se em uma relação afetiva com o jovem grumete Aleixo. O romance expõe tensões sociais da época, como o racismo, a marginalização e os preconceitos contra o desejo homoafetivo. Com narrativa ousada para seu tempo, Caminha revela os dilemas de personagens que desafiam convenções e enfrentam a intolerância de uma sociedade conservadora.',
    pdf: "BomCrioulo.pdf",
  },
  "o-ateneu": {
    titulo: "O Ateneu",
    ...
    paginas: "93 Páginas - PDF",
    paginas2: "222 Páginas - ONLINE",
    sinopse: '"O Ateneu" narra a experiência de Sérgio, um jovem que ingressa em um tradicional colégio interno do Rio de Janeiro. O ambiente, marcado por disciplina rígida e aparências sociais, revela-se um microcosmo da sociedade brasileira do século XIX. Entre amizades frágeis, rivalidades intensas e descobertas pessoais, Sérgio enfrenta a perda da inocência e o choque com a hipocrisia adulta. A obra expõe, com ironia e crítica, os limites da educação e os conflitos de uma juventude em formação.',
    pdf: "OAteneu.pdf",
  },
  "o-cortiço": {
    titulo: "O Cortiço",
    ...
    paginas: "118 Páginas - PDF",
    paginas2: "221 Páginas - ONLINE",
    sinopse: 'Aluísio Azevedo retrata as péssimas condições de vida dos moradores dos cortiços cariocas neste romance estrelado por dois imigrantes portugueses. A linguagem rebuscada do autor naturalista do século XIX é traduzida para os dias de hoje por meio das notas comentadas de Fátima Mesquita.',
    pdf: "Ocortico.pdf",
  },
  "memorias-de-um-sargento-de-milicias": {
    ...
    paginas: "110 Páginas - PDF",
    paginas2: "182 Páginas - ONLINE",
    sinopse: 'A história de Leonardo, um malandro carioca, filho de imigrantes portugueses, que passa por diversas peripécias e aventuras no Rio de Janeiro do século XIX, desde a infância até se tornar sargento de milícia, em um retrato irônico da sociedade.',
    pdf: "MemoriasdeumSargentodeMilicias.pdf",
  },
}
