<?php
// Coloque isso no topo do seu script salvar_avatar.php
...
// O navegador pode enviar uma requisição 'OPTIONS' primeiro (preflight request)
// Este bloco lida com isso para que a requisição 'POST' seguinte seja permitida.
